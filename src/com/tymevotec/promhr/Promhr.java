...
public class Promhr extends Activity {
	...
	setContentView(R.layout.activity_promhr); // Inflate the GUI
	...
	int arg3) {
	    ...
	    // the chronometer
	        ...
	        // Inflate the menu; this adds items to the action bar if it is present.
		        getMenuInflater().inflate(R.menu.promhr, menu);
	        return true;
		    }
